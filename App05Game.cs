...
namespace App05MonoGame
{
    ...
    public class App05Game : Game
    {
        ...
        public const int HD_Width = 650;
        public const int Height_Off_Display = -100;
        ...
        private void SetupSpaceShip()
        {
            ...
            shipSprite = new PlayerSprite(ship, HD_Width/2, HD_Height-150)
            {
                Direction = new Vector2(1, 0),
                Speed = 200,
                DirectionControl = DirectionControl.FourDirections
            };
    }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            int asteroidsAvoided = asteroidHandler.Update(gameTime);

            score += (100 * asteroidsAvoided);

            if (asteroidHandler.HasCollided(shipSprite) && shipSprite.IsAlive)
            {
                flameEffect.Play();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            asteroidHandler.Draw(spriteBatch);
